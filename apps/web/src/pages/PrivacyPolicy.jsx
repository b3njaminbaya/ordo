...
const SECTIONS = [
  {
    ...
    id: "collect",
    body: "We collect only what's necessary to deliver a great experience. This includes account information you provide during registration (username, email address, password hash), activity data generated as you use Ordo (tasks created, completed, due dates), and technical data such as browser type and IP address for security purposes.",
  ...
  },
  {
    ...
    id: "use",
    body: "Your data is used exclusively to provide, secure, and improve Ordo. Specifically: to authenticate your sessions, deliver notifications you've opted into, diagnose errors to keep the service reliable, and communicate important service updates.",
  ...
  },
  {
    ...
    id: "cookies",
    body: "Ordo does not use cookies, advertising trackers or third-party analytics. To keep you signed in and remember your theme, it stores a sign-in token and your preferences in your browser's local storage; signing out removes the token. Server-side error monitoring may record technical details (never passwords) so we can fix bugs.",
    highlight: null,
  },
  {
    Icon: Database,
    ...
    id: "retention",
    body: "We retain your account data for as long as your account is active or as needed to provide services. When you delete your account, your profile, comments and time entries are deleted immediately, except where we are legally required to retain data. Task lists you created in a workspace shared with teammates remain with that workspace; if you were its only member they are deleted too.",
    highlight: "You can delete your account at any time from Settings.",
  },
  {
    Icon: AlertTriangle,
    title: "Your Responsibilities",
    id: "responsibilities",
    body: "You are responsible for keeping your login credentials secure and for all activity that occurs under your account. Use a strong, unique password and enable caution when using Ordo on shared or public devices. Notify us immediately at b3njaminbaya@gmail.com if you suspect unauthorized access.",
    highlight: null,
  },
  {
    Icon: Scale,
  ...
  },
  {
    ...
    id: "contact",
    body: "If you have questions, concerns, or requests regarding this Privacy Policy or how your data is handled, reach out to us at b3njaminbaya@gmail.com. We aim to respond to all privacy inquiries within 5 business days.",
    highlight: null,
  },
];
    ...
    <section className="bg-sidebar py-24 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center relative">
        ...
        <p className="mt-5 text-lg text-white/70 max-w-xl mx-auto leading-relaxed">
          We built Ordo with privacy in mind. Here's exactly what data we collect, why we collect it, and how we protect it.
        </p>
      ...
      <div className="max-w-7xl mx-auto bg-primary/5 border border-primary/20 rounded-2xl p-6">
        ...
        <ul className="space-y-2">
          {[
            ...
            "Questions? Email us at b3njaminbaya@gmail.com — we reply within 5 business days.",
          ].map((item) => (
