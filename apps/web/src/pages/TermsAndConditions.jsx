...
const SECTIONS = [
  {
    ...
    id: "acceptance",
    body: "By accessing or using Ordo, you confirm that you are at least 16 years of age and agree to be bound by these Terms and Conditions and our Privacy Policy. If you are using Ordo on behalf of an organization, you represent that you have the authority to bind that organization to these terms.",
  ...
  },
  {
    ...
    title: "User Accounts",
    id: "accounts",
    body: "You must create an account to use Ordo. You are responsible for: maintaining the confidentiality of your login credentials, all activity that occurs under your account, keeping your account information accurate and up to date. You may not share your account with others or create accounts for any purpose other than using Ordo as intended.",
    highlight: null,
  },
  {
    Icon: AlertOctagon,
    ...
    id: "acceptable-use",
    body: "You agree not to use Ordo to: engage in any unlawful activity; upload or transmit malware, viruses, or harmful code; attempt to gain unauthorized access to our systems or other accounts; spam, harass, or harm other users; reverse-engineer, copy, or redistribute any part of our platform without permission; use the service in a way that could damage, disable, or impair it.",
  ...
  },
  {
    ...
    id: "ip",
    body: "All content, trademarks, trade dress, logos, and branding on Ordo are owned by us or our licensors and are protected by applicable intellectual property laws. We grant you a limited, non-exclusive, non-transferable license to use Ordo solely for its intended purpose. You retain ownership of content you create within the platform.",
    highlight: null,
  },
  {
    Icon: AlertOctagon,
    ...
    id: "liability",
    body: "Ordo is provided 'as is' without warranties of any kind, express or implied. To the fullest extent permitted by law, we disclaim all warranties including merchantability, fitness for a particular purpose, and non-infringement. We are not liable for any indirect, incidental, special, or consequential damages arising from your use of or inability to use Ordo.",
    highlight: null,
  },
  {
    Icon: XCircle,
    title: "Termination",
    id: "termination",
    body: "We reserve the right to suspend or terminate your account at our sole discretion, with or without notice, if we determine that you have violated these Terms. You may also delete your account at any time from your Account Settings. Upon termination, your right to use Ordo ceases immediately.",
    highlight: null,
  },
  {
    Icon: RefreshCw,
  ...
  },
  {
    ...
    title: "Contact",
    id: "contact",
    body: "For questions about these Terms and Conditions or to report a violation, please contact us at b3njaminbaya@gmail.com. For urgent security concerns, mark your subject line as 'URGENT' and we will prioritize your inquiry.",
    highlight: null,
  },
];

const SUMMARY = [
  "You must be 16+ to use Ordo.",
    ...
    <section className="bg-sidebar py-24 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center relative">
        ...
        <p className="mt-5 text-lg text-white/70 max-w-xl mx-auto leading-relaxed">
          These terms govern your use of Ordo. We've written them to be clear and fair — please read them before using our platform.
        </p>
